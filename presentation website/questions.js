...
const questions = [
  {
    ...
    answers: [
      { text: "Penelope", correct: true },
      { text: "Helen", correct: false },
      { text: "Clytemnestra", correct: false },
  ...
  {
    question: "What name does Odysseus give the Cyclops?",
    answers: [
  ...
  },
  {
    ...
    answers: [
      { text: "Alcinous", correct: true },
      { text: "Menelaus", correct: false },
      { text: "Nestor", correct: false },
  ...
  {
    question: "What test does Penelope propose for the suitors?",
    answers: [
      { text: "String Odysseus’ bow and shoot through axe heads", correct: true },
      { text: "Defeat Telemachus in combat", correct: false },
      { text: "Solve a riddle from Athena", correct: false },
      { text: "Swim across the sea", correct: false }
    ]
  },
  {
  ...
  {
    question: "Which suitor throws a stool at Odysseus while he is disguised as a beggar?",
    answers: [
      { text: "Antinous", correct: true },
      { text: "Eurymachus", correct: false },
      { text: "Amphinomus", correct: false },
      { text: "Leodes", correct: false }
    ]
  },
  {
